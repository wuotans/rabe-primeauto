...
export default function Register() {
  ...
  const handleResend = async () => {
    setError("");
    try { await api.auth.resendOtp(email); toast({ title: "Code sent", description: "Check your email for the new code." }); }
  ...
  if (showOtp) {
    return <AuthLayout icon={Mail} title="Verify your email" subtitle={`We sent a code to ${email}`}>
  ...
  return <AuthLayout icon={UserPlus} title="Create your account" subtitle="Sign up to get started" footer={<>Already have an account? <Link to="/login" className="text-primary font-medium hover:underline">Log in</Link></>}>
